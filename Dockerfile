...
ARG NEXT_PUBLIC_FREEPIK_API_BASE_URL
ARG NEXT_PUBLIC_FREEPIK_API_KEY
...
ENV NEXT_PUBLIC_FREEPIK_API_BASE_URL=${NEXT_PUBLIC_FREEPIK_API_BASE_URL}
ENV NEXT_PUBLIC_FREEPIK_API_KEY=${NEXT_PUBLIC_FREEPIK_API_KEY}
