        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  {t("vocabulary.meaning.part_of_speech")}{" "}
                ...
                >
                  <FormControl>
                    <SelectTrigger className="cursor-pointer">
                      <SelectValue
                        placeholder={t(
                          "vocabulary.meaning.part_of_speech_placeholder"
                        )}
                      />
                    </SelectTrigger>
                  </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("vocabulary.meaning.synonyms")}</FormLabel>
                <FormControl>
                  <Input
                    placeholder={t("vocabulary.meaning.synonyms_placeholder")}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("vocabulary.meaning.antonyms")}</FormLabel>
                <FormControl>
                  <Input
                    placeholder={t("vocabulary.meaning.antonyms_placeholder")}
                    value={field.value?.join(", ") || ""}
                    disabled={isReadOnly}
                    onChange={(e) => {
                      const value = e.target.value;
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-xs uppercase text-muted-foreground">
                          {t("vocabulary.definition.definition")} (EN){" "}
                          {t("common.form.required")}
                        </FormLabel>
                        <FormControl>
                          <Textarea
                            placeholder={t(
                              "vocabulary.definition.definition_placeholder"
                            )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-xs uppercase text-muted-foreground">
                          {t("vocabulary.definition.translation")} (VI){" "}
                          {t("common.form.required")}
                        </FormLabel>
                        <FormControl>
                          <Textarea
                            placeholder={t(
                              "vocabulary.definition.translation_placeholder"
                            )}
                            className="resize-none min-h-[60px]"
                            disabled={isReadOnly}
                            {...field}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-xs uppercase text-muted-foreground">
                          {t("vocabulary.definition.example")} (EN)
                        </FormLabel>
                        <FormControl>
                          <Textarea
                            placeholder={t(
                              "vocabulary.definition.example_placeholder"
                            )}
                            className="resize-none min-h-[60px]"
                            value={field.value || ""}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-xs uppercase text-muted-foreground">
                          {t("vocabulary.definition.example_translation")} (VI)
                        </FormLabel>
                        <FormControl>
                          <Textarea
                            placeholder={t(
                              "vocabulary.definition.example_translation_placeholder"
                            )}
                            className="resize-none min-h-[60px]"
                            value={field.value || ""}
                            onChange={field.onChange}
